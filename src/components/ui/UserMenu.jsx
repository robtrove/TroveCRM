...
export function UserMenu({ onNavigate, onLogout, user }) {
  ...
  return (
    <Menu as="div" className="relative">
      <Menu.Button className="flex items-center gap-2 p-1.5 hover:bg-gray-100 dark:hover:bg-dark-hover rounded-xl transition-colors">
        <img
          src={user?.avatar}
          alt={user?.name}
      ...
      <Menu.Items className="absolute right-0 mt-1 w-56 bg-white dark:bg-dark-card rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 focus:outline-none z-dropdown">
